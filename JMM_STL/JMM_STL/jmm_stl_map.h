#ifndef __JMM_STL_MAP
#define __JMM_STL_MAP
...
namespace JMM_STL
{
	...
	public:
		...
		template<class InputIterator>
		map(InputIterator first, InputIterator last, Compare& comp) : t(comp)
		{
			t.insert_unique(first, last);
		}
		...
		map<Key, T, Compare, Alloc>& operator=(const map<Key, T, Compare>& x)
		{
			t = x.t;
			return *this;
		}
