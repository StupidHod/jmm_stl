#ifndef __JMM_STL_NUMERIC
#define __JMM_STL_NUMBERIC
...
namespace JMM_STL
{
	...
	OutputIterator adjacent_difference(InputIterator first, InputIterator last, OutputIterator result)
	{
		...
		*result = *first;
		return __adjacent_difference(first, last, value_type(first));
	...
	OutputIterator adjacent_difference(InputIterator first, InputIterator last, OutputIterator result, BinaryOperation binary_op)
	{
		...
		*result = *first;
		return __adjacent_difference(first, last, value_type(first), binary_op);
	...
	BinaryOperation1 binary_op1, BinaryOperation2 binary_op2)
	{
		for (; first1 != last1; ++first1; ++first2)
		{
			init = binary_op(init , binary_op2(*first1 ,* first2));
		}
